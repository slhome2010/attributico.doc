...
| `attributico_add_script`             | подключение JavaScript-файла модуля на страницу товара                  |
| `attributico_product_form_before`    | внедрение дополнительных полей в форму товара                           |
