...
1\. В административной панели в разделе *Расширения ⇒ Модули* напротив модуля "Attribut&co" - кнопка "Деинсталировать".
...
Кроме этого будут созданы дополнительнеые таблицы для совместимости с будущими усиленными версиями модуля. Структуру таблиц можно посмотреть на [диаграмме](technical-specifications/database.md).
